...
//Initialising Constractor
  ...
  static final headline12StylenotoSerifBengali500 =
  ...
  static final headline16StylenotoSerifBengali700 =
      GoogleFonts.notoSerifBengali(
    color: AppColors.c202020,
    fontSize: 16.sp,
    fontWeight: FontWeight.w700, // Bold
  );
  static final headline16StylenotoSerifBengali = GoogleFonts.notoSerifBengali(
    color: AppColors.c202020,
    fontSize: 16.sp,
    fontWeight: FontWeight.w600, // Bold
  );
  static final headline16StylenotoSerifBengali700cFF737A =
      GoogleFonts.notoSerifBengali(
    color: AppColors.cFF737A,
    fontSize: 16.sp,
    fontWeight: FontWeight.w700, // Bold
  );
  static final headline18StylenotoSerifBengaliTextBold =
      GoogleFonts.notoSerifBengali(
    color: AppColors.headLine1Color,
    fontSize: 18.sp,
    fontWeight: FontWeight.w400, // Bold
  );
  static final headline20StylenotoSerifBengaliTextBold =
      GoogleFonts.notoSerifBengali(
    color: AppColors.c202020,
    fontSize: 20.sp,
    fontWeight: FontWeight.w700, // Bold
  );
  static final headline16StylenotoSerifBengaliTextBold =
      GoogleFonts.notoSerifBengali(
